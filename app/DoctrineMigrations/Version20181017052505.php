 ...
 */
class Version20181017052505 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE team_players (id INT NOT NULL, team_id INT NOT NULL, player_id INT NOT NULL, number INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE teams ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL');
    }
